...
//  Lab3
//
//  Created by Rory McEntee on 12/5/13.
...
private:
    ...
    int countFullNodes( BinaryNode *t )
    {
        ...
        return i + countFullNodes(t->left) + countFullNodes(t->right);
    }
...
int main() {
    ...
    cout << "Number of leaves " << t1.countLeaves() << endl;
    cout << "Number of full nodes " << t1.countFullNodes() << endl;
	cout << "Finding!" << endl;
